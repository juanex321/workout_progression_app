...
# root second — shared modules (progression, plan) are imported from there directly,
# so there are no local copies that can drift out of sync.
...
from routes import sessions, exercises, feedback, session53_correction
from db import (
